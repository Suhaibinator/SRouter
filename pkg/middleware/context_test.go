...
func TestTransactionContext(t *testing.T) {
	...
	retrievedTx, ok := scontext.GetTransaction[string](ctx) // Use scontext
	...
	retrievedTx, ok = scontext.GetTransaction[string](ctxWithTx1) // Use scontext
	...
	retrievedTx, ok = scontext.GetTransaction[string](ctxWithTx2) // Use scontext
	...
	retrievedTx, ok = scontext.GetTransaction[int](ctxWithIntUser)                             // Use scontext
	...
	retrievedTx, ok = scontext.GetTransaction[string](req.Context()) // Use scontext
	...
	retrievedTx, ok = scontext.GetTransaction[string](reqWithTx.Context()) // Use scontext
...
func TestFlagContext(t *testing.T) {
	...
	val, ok := scontext.GetFlag[string](ctx, flagName1) // Use scontext
	...
	// 3. Get flag1
	val, ok = scontext.GetFlag[string](ctxWithFlag1, flagName1) // Use scontext
	...
	val, ok = scontext.GetFlag[string](ctxWithFlag1, nonExistentFlag) // Use scontext
	...
	val, ok = scontext.GetFlag[string](ctxWithBothFlags, flagName1) // Use scontext
	...
	val, ok = scontext.GetFlag[string](ctxWithBothFlags, flagName2) // Use scontext
	...
	val, ok = scontext.GetFlag[string](ctxOverwritten, flagName1) // Use scontext
	...
	val, ok = scontext.GetFlag[string](ctxOverwritten, flagName2) // Use scontext
	...
	val, ok = scontext.GetFlag[int](ctxWithIntUser, flagName1)                                  // Use scontext
	assert.True(ok, "Should work with different generic types [int, CustomUser]")
...
func TestGetFlag(t *testing.T) {
	...
	val, ok := scontext.GetFlag[string](req.Context(), flagName) // Use scontext
	...
	val, ok = scontext.GetFlag[string](reqWithFlag.Context(), flagName) // Use scontext
	...
	val, ok = scontext.GetFlag[string](reqWithFlag.Context(), "other-flag") // Use scontext
