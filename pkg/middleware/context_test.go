...
func TestTransactionContext(t *testing.T) {
	...
	retrievedTx, ok := scontext.GetTransaction(ctx) // Use scontext
	...
	retrievedTx, ok = scontext.GetTransaction(ctxWithTx1) // Use scontext
	...
	retrievedTx, ok = scontext.GetTransaction(ctxWithTx2) // Use scontext
	...
	retrievedTx, ok = scontext.GetTransaction(ctxWithIntUser)                                  // Use scontext
	...
	retrievedTx, ok = scontext.GetTransaction(req.Context()) // Use scontext
	...
	retrievedTx, ok = scontext.GetTransaction(reqWithTx.Context()) // Use scontext
...
func TestFlagContext(t *testing.T) {
	...
	val, ok := scontext.GetFlag(ctx, flagName1) // Use scontext
	...
	// 3. Get flag1
	val, ok = scontext.GetFlag(ctxWithFlag1, flagName1) // Use scontext
	...
	val, ok = scontext.GetFlag(ctxWithFlag1, nonExistentFlag) // Use scontext
	...
	val, ok = scontext.GetFlag(ctxWithBothFlags, flagName1) // Use scontext
	...
	val, ok = scontext.GetFlag(ctxWithBothFlags, flagName2) // Use scontext
	...
	val, ok = scontext.GetFlag(ctxOverwritten, flagName1) // Use scontext
	...
	val, ok = scontext.GetFlag(ctxOverwritten, flagName2) // Use scontext
	...
	val, ok = scontext.GetFlag(ctxWithIntUser, flagName1)                                       // Use scontext
	assert.True(ok, "Should work with different generic types [int, CustomUser]")
...
func TestGetFlag(t *testing.T) {
	...
	val, ok := scontext.GetFlag(req.Context(), flagName) // Use scontext
	...
	val, ok = scontext.GetFlag(reqWithFlag.Context(), flagName) // Use scontext
	...
	val, ok = scontext.GetFlag(reqWithFlag.Context(), "other-flag") // Use scontext
