...
func TestCORSPreflight(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "Valid preflight - default simple methods and headers",
			corsConfig: &CORSConfig{
				Origins: []string{"http://example.com"},
			},
			requestOrigin:  "http://example.com",
			...
			requestHeaders: "Content-Type",
			expectOrigin:   "http://example.com",
			expectMethods:  "GET, HEAD, POST",
			expectHeaders:  "Accept, Accept-Language, Content-Language, Content-Type",
			expectStatus:   http.StatusNoContent,
		},
		{
			name: "Valid preflight - default methods with configured headers",
			corsConfig: &CORSConfig{
				Origins: []string{"http://example.com"},
		...
		{
			name: "Valid preflight - subsecond max age is omitted",
			corsConfig: &CORSConfig{
				Origins: []string{"http://example.com"},
		...
		{
			name: "Valid preflight - configured methods with default headers",
			corsConfig: &CORSConfig{
				Origins: []string{"http://example.com"},
				Methods: []string{"PUT"},
			},
		...
		{
			name: "Preflight - default methods reject non-simple method",
			corsConfig: &CORSConfig{
				Origins: []string{"http://example.com"},
			},
			requestOrigin:  "http://example.com",
		...
		{
			name: "Preflight - default headers reject non-safelisted header",
			corsConfig: &CORSConfig{
				Origins: []string{"http://example.com"},
			},
			requestOrigin:  "http://example.com",
